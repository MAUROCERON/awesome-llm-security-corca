...
- [AI Agent Security Mini-Audit](https://github.com/MAUROCERON/ai-agent-security-mini-audit): no-login launch-readiness self-check and mini-audit checklist for agentic workflows, prompt-injection risk, tool permissions, secrets handling, logging and approval gates. ![GitHub Repo stars](https://img.shields.io/github/stars/MAUROCERON/ai-agent-security-mini-audit?style=social)
