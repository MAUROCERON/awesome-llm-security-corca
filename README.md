...
- [AI Agent Risk Self-Check](https://github.com/MAUROCERON/ai-agent-security-mini-audit): no-login launch-readiness self-check for AI agents and browser/tool-using workflows, with a checklist and sample report. ![GitHub Repo stars](https://img.shields.io/github/stars/MAUROCERON/ai-agent-security-mini-audit?style=social)
